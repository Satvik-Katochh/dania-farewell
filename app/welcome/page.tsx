...
// const FloatingUnicorns = () => {
//   const [unicornsArray, setUnicornsArray] = useState<Unicorn[]>([]);

//   // Function to create unicorns at random positions
//   const createUnicorn = () => {
//     const newUnicorn: Unicorn = {
//       id: unicornsArray.length + 1,
//       y: Math.random() * window.innerHeight,
//       duration: Math.random() * 10 + 10,
//     };

//     setUnicornsArray((prev) => [...prev, newUnicorn]);
//   };

//   // Use useEffect to initialize unicorns on component mount
//   useEffect(() => {
//     for (let i = 0; i < 5; i++) {
//       createUnicorn();
//     }
...
//   return (
//     <>
//       {unicornsArray.map((unicorn) => (
//         <motion.div
//           key={unicorn.id}
//           className="absolute"
//           initial={{ x: -100, y: unicorn.y }}
//           animate={{
//             x: window.innerWidth + 100,
//             y: unicorn.y,
//             rotate: 360,
